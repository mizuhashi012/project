  ...
  <div class="site-wrap"  id="home-section">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-12" style="position: relative;" data-aos="fade-up">
            ...
            <img src="assets/images/landing_1.png" alt="Image" class="img-fluid img-absolute">
    ...
    <div class="site-section bg-light" id="about-section">
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-lg-6">
            <img src="assets/images/about_1.jpg" alt="Image" class="img-fluid mb-5 mb-lg-0 rounded shadow">
          </div>
